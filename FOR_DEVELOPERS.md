...
| ------- | ------- | ------- |
|[Node.js](https://nodejs.org/ja/)|10.23.2以上|必須|
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/Terachan0117/covid19-toyama)
...
| ---- | ---- | ---- |
|`master`|`production`|本番サイト https://stopcovid19-toyama.netlify.app/|
|`staging`|`gh-pages`|ステージングサイト https://stg-covid19-toyama.netlify.app/|
...
| ステージング | staging | https://stg-covid19-toyama.netlify.app/ | 管理者のみ | 本番前の最終確認用。管理者以外の Pull Request は禁止です。 |
| 本番 | master | https://stopcovid19-toyama.netlify.app/ | 管理者のみ | 管理者以外の Pull Request は禁止です。 |

### 5-2. システムで利用しているブランチ

| 目的 | ブランチ | 確認URL | 備考 |
| ---- | -------- | ---- | ---- |
| 本番サイトHTML | production | https://stopcovid19-toyama.netlify.app/ | 静的ビルドされたHTMLが置いてある場所 |
| ステージングサイト HTML | gh-pages | https://stg-covid19-toyama.netlify.app/ | 静的ビルドされたHTMLが置いてある場所 |
