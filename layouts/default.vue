  ...
  head() {
    ...
    const mInfo: MetaInfo = {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://stopcovid19-toyama.netlify.app${this.$route.path}`,
        },
        ...(linksAlternate as []),
      ],
      // Disable prettier for readability purposes
      // eslint-disable-next-line prettier/prettier
      titleTemplate: `%s | ${this.$t('富山県')} ${this.$t('新型コロナウイルス感染症')} ${this.$t('対策サイト')}`,
      meta: [
        {
          hid: 'author',
          name: 'author',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://stopcovid19-toyama.netlify.app${this.$route.path}`,
        },
        ogLocale,
        {
          hid: 'og:title',
